  ...
  rebrandItems: [
    ...
    },
    {
      ...
      names: [
        ...
        "Web Designers Near San Francisco, CA",
      ],
      visibility: false,
    },
    {
...
const rebrandSlice = createSlice({
  name: "rebrandItems",
  initialState,
  reducers: {
    // eslint-disable-next-line no-unused-vars
    isHidden: (state, action) => {
      state.rebrandItems.forEach((item) => {
...
export const { isHidden } = rebrandSlice.actions;

export default rebrandSlice.reducer;
